    ...
    <table border="1" style="width: 80%; text-align: center">
        <tr>
            <th>
                ...
                <a href="pagi.php">Kelas Pagi</a>
            </th>
            <th colspan=>
                <!-- Tautan untuk Data Perempuan -->
                <a href="siang.php">Kelas Siang</a>
            </th>
        </tr>
    </table>
    ...
    <table border="1" >
        ...
        while($detail = mysqli_fetch_array($data)){
            ...
            <tr>
                ...
                <td><?php echo $detail['nomor_botcamp']; ?></td>
                <td><?php echo $detail['nama_peserta']; ?></td>
                <td><?php echo $detail['nama_botcampt']; ?></td>
                <td><?php echo $detail['jadwal_kelas']; ?></td>
                <td><?php echo $detail['no_tlpn']; ?></td>
            </tr>
            <?php
        }
        ?>
